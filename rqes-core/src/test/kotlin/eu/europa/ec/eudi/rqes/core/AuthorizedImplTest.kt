...
class AuthorizedImplTest {
    ...
    @Test
    fun `verify getCredentialAuthorizationUrl sets the properties documentsToSign documentDigestList credAuthRequestPrepared and returns the credential authorization url`() =
        runTest {
